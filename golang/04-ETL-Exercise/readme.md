...
hint: Write and group tests around business logic; not around coding logic.  For example, one test function could cover `hasCheese`, another `hasFruit`, another `isVegetarian`, and so on.
